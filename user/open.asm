...
user/_open：     文件格式 elf64-littleriscv
...
main()
{
  ...
  10:	7bc50513          	addi	a0,a0,1980 # 7c8 <malloc+0xe4>
  14:	00000097          	auipc	ra,0x0
  18:	2da080e7          	jalr	730(ra) # 2ee <open>
    write(fd,"ooo\n",4);//往文件描述符写4个字节
  1c:	4611                	li	a2,4
  1e:	00000597          	auipc	a1,0x0
  22:	7ba58593          	addi	a1,a1,1978 # 7d8 <malloc+0xf4>
  26:	00000097          	auipc	ra,0x0
  2a:	2a8080e7          	jalr	680(ra) # 2ce <write>
    exit(0);
  2e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	45650513          	addi	a0,a0,1110 # 7e8 <digits>
 39a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 462:	38ab8b93          	addi	s7,s7,906 # 7e8 <digits>
 ...
 5a2:	24290913          	addi	s2,s2,578 # 7e0 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66a:	19a7b783          	ld	a5,410(a5) # 800 <freep>
 ...
 698:	00e6ea63          	bltu	a3,a4,6ac <free+0x50>
{
 ...
 6da:	12f73523          	sd	a5,298(a4) # 800 <freep>
}
 6de:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70c:	0f853503          	ld	a0,248(a0) # 800 <freep>
 ...
 734:	0d090913          	addi	s2,s2,208 # 800 <freep>
  if(p == (char*)-1)
 738:	5afd                	li	s5,-1
 73a:	a88d                	j	7ac <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 73c:	00000797          	auipc	a5,0x0
 740:	0cc78793          	addi	a5,a5,204 # 808 <base>
 744:	00000717          	auipc	a4,0x0
 748:	0af73e23          	sd	a5,188(a4) # 800 <freep>
 74c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 76e:	08a73b23          	sd	a0,150(a4) # 800 <freep>
      return (void*)(p + 1);
