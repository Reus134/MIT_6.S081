...
main(int argc, char *argv[])
{
  ...
  20:	55010413          	addi	s0,sp,1360
  int pid,n,buf_index=0;
  char buf,arg[MAX_ARG_LEN], *args[MAXARG];

  if(argc < 2){
  24:	4785                	li	a5,1
  26:	08a7d963          	bge	a5,a0,b8 <main+0xb8>
  2a:	8a2a                	mv	s4,a0
  2c:	892e                	mv	s2,a1
    printf("args error!\n");
    exit(0);
  ...
  34:	8a850513          	addi	a0,a0,-1880 # 8d8 <malloc+0xf8>
  38:	00000097          	auipc	ra,0x0
  3c:	6ea080e7          	jalr	1770(ra) # 722 <printf>
  for(int i=1;i<argc;i++)
  40:	0921                	addi	s2,s2,8
  42:	ab840493          	addi	s1,s0,-1352
  46:	ffea099b          	addiw	s3,s4,-2
  4a:	1982                	slli	s3,s3,0x20
  4c:	0209d993          	srli	s3,s3,0x20
  50:	098e                	slli	s3,s3,0x3
  52:	ac040793          	addi	a5,s0,-1344
  56:	99be                	add	s3,s3,a5
    {
      
    args[i-1]=argv[i];
    printf("%s\n",args[i-1]);
  58:	00001a97          	auipc	s5,0x1
  5c:	888a8a93          	addi	s5,s5,-1912 # 8e0 <malloc+0x100>
    args[i-1]=argv[i];
  ...
  6c:	6ba080e7          	jalr	1722(ra) # 722 <printf>
  for(int i=1;i<argc;i++)
  70:	0921                	addi	s2,s2,8
  72:	04a1                	addi	s1,s1,8
  74:	ff3496e3          	bne	s1,s3,60 <main+0x60>
  int pid,n,buf_index=0;
  78:	4481                	li	s1,0
      ...
      else if(pid==0)
      {
        //子进程
        args[argc-1]=arg;//放进去
  7a:	fffa079b          	addiw	a5,s4,-1
  7e:	078e                	slli	a5,a5,0x3
  80:	fc040713          	addi	a4,s0,-64
  84:	00f70933          	add	s2,a4,a5
        args[argc]=0;
  88:	0a0e                	slli	s4,s4,0x3
  8a:	9a3a                	add	s4,s4,a4
  while((n=read(stdin,&buf,1)>0))
  8c:	4605                	li	a2,1
  8e:	fbf40593          	addi	a1,s0,-65
  92:	4501                	li	a0,0
  94:	00000097          	auipc	ra,0x0
  98:	32e080e7          	jalr	814(ra) # 3c2 <read>
  9c:	08a05763          	blez	a0,12a <main+0x12a>
    if(buf=='\n')
  a0:	fbf44783          	lbu	a5,-65(s0)
  a4:	4729                	li	a4,10
  a6:	02e78663          	beq	a5,a4,d2 <main+0xd2>
        wait(0);
        buf_index=0;
      }
    }
  ...
  aa:	fc040713          	addi	a4,s0,-64
  ae:	9726                	add	a4,a4,s1
  b0:	bef70c23          	sb	a5,-1032(a4)
  b4:	2485                	addiw	s1,s1,1
  b6:	bfd9                	j	8c <main+0x8c>
    printf("args error!\n");
  b8:	00001517          	auipc	a0,0x1
  bc:	81050513          	addi	a0,a0,-2032 # 8c8 <malloc+0xe8>
  c0:	00000097          	auipc	ra,0x0
  c4:	662080e7          	jalr	1634(ra) # 722 <printf>
    exit(0);
  c8:	4501                	li	a0,0
  ca:	00000097          	auipc	ra,0x0
  ce:	2e0080e7          	jalr	736(ra) # 3aa <exit>
      arg[buf_index]=0;//读完了
  d2:	fc040793          	addi	a5,s0,-64
  d6:	97a6                	add	a5,a5,s1
  d8:	be078c23          	sb	zero,-1032(a5)
      if((pid=fork())<0)
  dc:	00000097          	auipc	ra,0x0
  e0:	2c6080e7          	jalr	710(ra) # 3a2 <fork>
  e4:	02054263          	bltz	a0,108 <main+0x108>
      else if(pid==0)
  e8:	e915                	bnez	a0,11c <main+0x11c>
        args[argc-1]=arg;//放进去
  ea:	bb840793          	addi	a5,s0,-1096
  ee:	aef93c23          	sd	a5,-1288(s2)
        args[argc]=0;
  f2:	ae0a3c23          	sd	zero,-1288(s4)
        exec(args[0],args);//exec
  f6:	ab840593          	addi	a1,s0,-1352
  fa:	ab843503          	ld	a0,-1352(s0)
  fe:	00000097          	auipc	ra,0x0
 102:	2e4080e7          	jalr	740(ra) # 3e2 <exec>
 106:	b759                	j	8c <main+0x8c>
        fprintf(stderr,"fork error\n");
 108:	00000597          	auipc	a1,0x0
 10c:	7e058593          	addi	a1,a1,2016 # 8e8 <malloc+0x108>
 110:	4509                	li	a0,2
 112:	00000097          	auipc	ra,0x0
 116:	5e2080e7          	jalr	1506(ra) # 6f4 <fprintf>
 11a:	bf8d                	j	8c <main+0x8c>
        wait(0);
 11c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 492:	47250513          	addi	a0,a0,1138 # 900 <digits>
 496:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 55e:	3a6b8b93          	addi	s7,s7,934 # 900 <digits>
 ...
 69e:	25e90913          	addi	s2,s2,606 # 8f8 <malloc+0x118>
        while(*s != 0){
...
free(void *ap)
{
 ...
 766:	1b67b783          	ld	a5,438(a5) # 918 <freep>
...
malloc(uint nbytes)
{
 ...
 808:	11453503          	ld	a0,276(a0) # 918 <freep>
 ...
 830:	0ec90913          	addi	s2,s2,236 # 918 <freep>
  if(p == (char*)-1)
 834:	5afd                	li	s5,-1
 836:	a88d                	j	8a8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 838:	00000797          	auipc	a5,0x0
 83c:	0e878793          	addi	a5,a5,232 # 920 <base>
 840:	00000717          	auipc	a4,0x0
 844:	0cf73c23          	sd	a5,216(a4) # 918 <freep>
 848:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86a:	0aa73923          	sd	a0,178(a4) # 918 <freep>
      return (void*)(p + 1);
