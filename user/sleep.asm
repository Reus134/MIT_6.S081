...
int main(int argc, char const * argv[])//注意这const 因为atoi的参数是const
{
  ...
  12:	7ca50513          	addi	a0,a0,1994 # 7d8 <malloc+0xe8>
  16:	00000097          	auipc	ra,0x0
  1a:	61c080e7          	jalr	1564(ra) # 632 <printf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	00000097          	auipc	ra,0x0
  24:	29a080e7          	jalr	666(ra) # 2ba <exit>
    }
    int time=atoi(argv[1]);
  28:	6588                	ld	a0,8(a1)
  2a:	00000097          	auipc	ra,0x0
  2e:	190080e7          	jalr	400(ra) # 1ba <atoi>
    sleep(time);
  32:	00000097          	auipc	ra,0x0
  36:	318080e7          	jalr	792(ra) # 34a <sleep>
    exit(0);
  3a:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 7c8:	b7e080e7          	jalr	-1154(ra) # 342 <sbrk>
  if(p == (char*)-1)
